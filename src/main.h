...
static const int LAST_POW_BLOCK = 10000; // at 60 second blocks + Pos block will be about 18 days from launch
...
#define FOUNDATION "ATrNQhUdNMQdSW3b7HyUfTx8UVK7ZVb3oV"
...
static const uint256 hashGenesisBlock("000003778a5b3e9de91a6cd94ab2dbbaa39ed55d229b887321c3f9f0f2f59efb");
...
public:
    ...
    {
        // angelcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // angelcoin: get transaction coin age
...
public:
    ...
    // angelcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // angelcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // angelcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // angelcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // angelcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // angelcoin: block index flags
    enum  
    {
